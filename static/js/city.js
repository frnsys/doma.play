...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(14)(proto, TO_PRIMITIVE, __webpack_require__(131));
...
var $export = __webpack_require__(0);
var toInteger = __webpack_require__(22);
var aNumberValue = __webpack_require__(85);
var repeat = __webpack_require__(78);
...
$export($export.S + $export.F * !__webpack_require__(9), 'Object', { defineProperties: __webpack_require__(101) });
...
// @@match logic
__webpack_require__(50)('match', 1, function (defined, MATCH, $match, maybeCallNative) {
  return [
...
// @@replace logic
__webpack_require__(50)('replace', 2, function (defined, REPLACE, $replace, maybeCallNative) {
  return [
...
// @@search logic
__webpack_require__(50)('search', 1, function (defined, SEARCH, $search, maybeCallNative) {
  return [
...
// @@split logic
__webpack_require__(50)('split', 2, function (defined, SPLIT, $split, maybeCallNative) {
  var internalSplit;
  if (
    'abbc'[$SPLIT](/(b)*/)[1] == 'c' ||
